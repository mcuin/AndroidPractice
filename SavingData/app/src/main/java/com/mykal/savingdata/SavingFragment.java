 ...
 * {@link SavingFragment.OnFragmentInteractionListener} interface
...
public class SavingFragment extends Fragment {
    ...
    SharedPreferences sharedPreferences2 = getActivity().getSharedPreferences(Context.MODE_PRIVATE);

    public void save() {
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt(getString(R.string.highScore), newHighScore);
        editor.commit();
    }

    public void read() {
        int defaultValue = getResources().getInteger(R.string.saved_high_score_default);
        long high_score = sharedPreferences.getInt(getString(R.string.saved_high_score), defaultValue);
    }
